...
function speaker(cell) {
  rect(cell, 3, 9, 5, 7, colors.blueDark);
  line(cell, 8, 9, 13, 5, colors.blueDark);
  line(cell, 8, 15, 13, 19, colors.blueDark);
  rect(cell, 12, 5, 3, 15, colors.blue);
  line(cell, 13, 6, 13, 18, colors.blueLight);
  line(cell, 17, 8, 20, 11, colors.green);
  line(cell, 20, 11, 20, 14, colors.green);
  line(cell, 20, 14, 17, 17, colors.green);
  dot(cell, 18, 11, colors.greenLight);
  dot(cell, 18, 14, colors.greenLight);
}
